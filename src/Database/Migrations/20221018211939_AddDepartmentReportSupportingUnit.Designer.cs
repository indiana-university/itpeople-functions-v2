...
namespace Database.Migrations
{
    ...
    [Migration("20221018211939_AddDepartmentReportSupportingUnit")]
    partial class AddDepartmentReportSupportingUnit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Department", b =>
                {
                    ...
                    b.Property<int?>("ReportSupportingUnitId")
                        .HasColumnName("report_supporting_unit_id")
                        .HasColumnType("integer");

                    b.HasKey("Id")
                        .HasName("pk_departments");

                    b.HasIndex("ReportSupportingUnitId")
                        .HasName("ix_departments_report_supporting_unit_id");
            ...
            modelBuilder.Entity("Models.SupportRelationship", b =>
                {
                    ...
                    b.HasIndex("SupportTypeId")
                        .HasName("ix_support_relationships_support_type_id");
            ...
            modelBuilder.Entity("Models.SupportType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("Models.Department", b =>
                {
                    b.HasOne("Models.Unit", "ReportSupportingUnit")
                        .WithMany()
                        .HasForeignKey("ReportSupportingUnitId")
                        .HasConstraintName("fk_departments_units_report_supporting_unit_id");
                });
            ...
            modelBuilder.Entity("Models.SupportRelationship", b =>
                {
                    ...
                    b.HasOne("Models.SupportType", "SupportType")
                        .WithMany()
                        .HasForeignKey("SupportTypeId")
                        .HasConstraintName("fk_support_relationships_support_types_support_type_id");
