...
namespace Database.Migrations
{
    ...
    [Migration("20210202204754_AddContentColumnsToLogsTable")]
    partial class AddContentColumnsToLogsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.MemberTool", b =>
                {
                    ...
                    b.Property<int?>("UnitMemberId")
                        .HasColumnName("unit_member_id")
                        .HasColumnType("integer");

                    b.HasKey("Id")
                        .HasName("pk_unit_member_tools");

                    b.HasIndex("UnitMemberId")
                        .HasName("ix_unit_member_tools_unit_member_id");
            ...
            modelBuilder.Entity("Models.MemberTool", b =>
                {
                    b.HasOne("Models.UnitMember", null)
                        .WithMany("MemberTools")
                        .HasForeignKey("UnitMemberId")
                        .HasConstraintName("fk_unit_member_tools_unit_members_unit_member_id");
                });
