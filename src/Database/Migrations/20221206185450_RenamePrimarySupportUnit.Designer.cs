...
namespace Database.Migrations
{
    ...
    [Migration("20221206185450_RenamePrimarySupportUnit")]
    partial class RenamePrimarySupportUnit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Department", b =>
                {
                    ...
                    b.Property<int?>("PrimarySupportUnitId")
                        .HasColumnName("primary_support_unit_id")
                        .HasColumnType("integer");

                    b.HasKey("Id")
                        .HasName("pk_departments");

                    b.HasIndex("PrimarySupportUnitId")
                        .HasName("ix_departments_primary_support_unit_id");
            ...
            modelBuilder.Entity("Models.Department", b =>
                {
                    b.HasOne("Models.Unit", "PrimarySupportUnit")
                        .WithMany()
                        .HasForeignKey("PrimarySupportUnitId")
                        .HasConstraintName("fk_departments_units_primary_support_unit_id");
                });
