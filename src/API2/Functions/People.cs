...
namespace API.Functions
{
    public static class People
    {
        ...
        public static Task<HttpResponseData> PeopleGetAll(
        ...
        public static Task<HttpResponseData> PeopleGetOne(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "people/{id}")] HttpRequestData req, string id) 
            =>  Security.Authenticate(req)
                .Bind(requestor => 
        ...
        [OpenApiResponseWithBody(HttpStatusCode.NotFound, MediaTypeNames.Application.Json, typeof(ApiError), Description = "No person was found with the provided ID.")]
        public static Task<HttpResponseData> PeopleGetMemberships(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "people/{id}/memberships")] HttpRequestData req, string id) 
            => Security.Authenticate(req)
                .Bind(_ => 
                    int.TryParse(id, out int value)
        ...
        public static Task<HttpResponseData> PeopleUpdate(
            [HttpTrigger(AuthorizationLevel.Anonymous, "put", Route = "people/{id}")] HttpRequestData req, int id) 
            => Security.Authenticate(req)
        ...
        public static Task<HttpResponseData> PeopleLookup(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "people-lookup")] HttpRequestData req) 
            => Security.Authenticate(req)
        ...
        public static Task<HttpResponseData> PeopleWithHRGetOne(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "people/withHR/{netId}")] HttpRequestData req, string netId)
            => Security.Authenticate(req)
