    ...
    public class TasksTests
    {
		public class Tools : ApiTest
		{
			...
			public async Task DeserializesDenodoBuildings()
			{
				...
				var badRawBuildings = results.Elements.Where(b => string.IsNullOrWhiteSpace(b.Name));
				Assert.AreEqual(0, badRawBuildings.Count());
				Assert.AreEqual(3, results.Elements.Count());
			}
